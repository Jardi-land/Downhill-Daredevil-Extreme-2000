...
class DeathScreen:
    def __init__(self, score, best) -> None:
        ...
        self.background_button = Button(self.background_text, (480/2, 270/2), self.ui_spritesheet, "Null")
        
        self.background_button = Button(self.background_text, (480/2 - self.background_button.draw().get_width()/2, 270/2 - self.background_button.draw().get_height()/2), self.ui_spritesheet, "Null", True)
        ...
        self.replay_button = Button(self.replay_text, (480/2, 200), self.ui_spritesheet, "play")
        
        self.replay_button = Button(self.replay_text, (480/2 - self.replay_button.draw().get_width()/2, 200 - self.replay_button.draw().get_height()/2), self.ui_spritesheet, "play")
    ...
    def draw(self):
        self.surface.blit(self.background_button.update(), (self.background_button.pos[0], self.background_button.pos[1]))
        self.surface.blit(self.game_over_text, (480/2 - self.game_over_text.get_width()/2, 135/2 - self.game_over_text.get_height()/2))
        self.surface.blit(self.score_text, (480/2 - self.score_text.get_width()/2, self.background_button.pos[1] + 10))
        self.surface.blit(self.best_text, (480/2 - self.score_text.get_width()/2, self.background_button.pos[1] + self.background_button.size[1] - 20))
        self.surface.blit(self.replay_button.update(), (self.replay_button.pos[0], self.replay_button.pos[1]))
