...
class Button:
    def __init__(self,
        ...
        self.surface = pygame.Surface((self.size[0] + 8, self.size[1] + 8)).convert_alpha()
        self.surface.fill((0, 0, 0, 0))

        self.surface.blit(self.button_surface_dict["corner_top_left"], (0, 0))
        self.surface.blit(self.button_surface_dict["corner_top_right"], (self.surface.get_width() - self.button_surface_dict["corner_top_right"].get_width(), 0))
        for i in range(self.surface.get_width() - 6):
            self.surface.blit(self.button_surface_dict["top"], (i + 3, 0))
            self.surface.blit(self.button_surface_dict["bottom"], (i + 3, self.surface.get_height() - self.button_surface_dict["bottom"].get_height()))
        for i in range(self.surface.get_height() - 8):
            self.surface.blit(self.button_surface_dict["left"], (0, i + 3))
            self.surface.blit(self.button_surface_dict["right"], (self.surface.get_width() - self.button_surface_dict["right"].get_width(), i + 3))
        self.surface.blit(self.button_surface_dict["corner_bottom_left"], (0, self.surface.get_height() - self.button_surface_dict["corner_bottom_left"].get_height()))
        self.surface.blit(self.button_surface_dict["corner_bottom_right"], (self.surface.get_width() - self.button_surface_dict["corner_bottom_right"].get_width(), self.surface.get_height() - self.button_surface_dict["corner_bottom_right"].get_height()))
        self.surface.blit(al.im_scale(self.button_surface_dict["center"], (self.size[0] + 2, self.size[1] + 2)), (3, 2))
        ...
        self.surface_click.blit(self.button_surface_dict["corner_bottom_left_click"], (0, self.surface_click.get_height() - self.button_surface_dict["corner_bottom_left_click"].get_height()))
        self.surface_click.blit(self.button_surface_dict["corner_bottom_right_click"], (self.surface_click.get_width() - self.button_surface_dict["corner_bottom_right_click"].get_width(), self.surface_click.get_height() - self.button_surface_dict["corner_bottom_right_click"].get_height()))
        for i in range(self.surface.get_width() - 6):
            self.surface_click.blit(self.button_surface_dict["bottom_click"], (i + 3, self.surface.get_height() - self.button_surface_dict["bottom_click"].get_height()))
        ...
        self.grey_mask_surface = self.grey_mask.to_surface(setcolor=(34, 34, 34, 140)).convert_alpha()
